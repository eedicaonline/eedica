    ...
    <div class="uk-container uk-container-expand uk-padding
        ...
        <div class="uk-overflow-auto">
            ...
            <form class="uk-form-stacked" role="form">
                <div>
                    <label class="uk-form-label">اسم التصريح</label>
                ...
                <div class="uk-margin">
                    ...
                    class="uk-input"
                    name="display_name" value="{{ $role->display_name }}" disabled>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    class="uk-input"
                    name="created_at" value="{{ $role->created_at }}" disabled>
                </div>
                ...
                <div class="uk-margin">
                    ...
                    class="uk-input"
                    name="update_at" value="{{ $role->updated_at }}" disabled>
                </div>
            </form>
